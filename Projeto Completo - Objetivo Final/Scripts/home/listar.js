...
function ListarCliente() {
    ...
    for (var i = 0; i < clientes.length; i++) {
        tagsTbody += '<tr onMouseOver="javascript: onClienteAtivoMouseOver(this, ' + clientes[i].isAtivo + ');">'
        ...
        tagsTbody += '<td>'
        tagsTbody += "<a href='javascript:void(0)' onclick=\"javascript: ExcluirCliente(" + i.toString() + ");\">Excluir</a>";
        tagsTbody += '</td>'
        tagsTbody += '</tr>'
    }

    var tbodyClientes = document.getElementById('tbodyListaCliente');
    tbodyClientes.innerHTML = tagsTbody;
}
